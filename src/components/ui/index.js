...
export function Button({
  ...
  const variants = {
    primary:
      "bg-primary text-white shadow-lg shadow-emerald-500/20 hover:bg-primary-hover",
    secondary:
      "bg-white text-gray-900 border border-gray-100 shadow-sm hover:bg-gray-50",
    outline:
      "bg-transparent border border-gray-200 text-gray-600 hover:border-primary hover:text-primary",
