...
export async function POST(request, { params }) {
  ...
  try {
    ...
    console.log("✅ Acceptation d'offre:", {
      transaction_id,
      offer_id,
    ...
    if (!res.ok) {
      ...
      console.error("❌ Erreur API accept:", {
        status: res.status,
    ...
    console.log("✅ Réponse brute API accept:", responseText);
    ...
    if (!data || data === null) {
      console.log("✅ Offre acceptée (réponse vide/null)");
      return NextResponse.json({
        success: true,
